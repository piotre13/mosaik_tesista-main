...
#DONE >>> x_int [t-1] how to fix at first iteration???
def calc_moisture_content_in_zone_local(bpr, tsd, t):
    ...
    if t==0:
        ...
        x_int_a_ztc_t_1 = tsd['x_int'][t-1] ###HOW TO CHANGE THIS
...
#DONE
def calc_Qgain_lat(tsd, schedules, t):
    # TODO: Documentation
    ...
    KG_PER_GRAM = 0.001
    HOURS_PER_SEC = 1 / SECONDS_PER_HOUR


    tsd['w_int'][t] = schedules.loc[t,'X_gh'] * KG_PER_GRAM * HOURS_PER_SEC # kg/s
    tsd['Q_gain_lat_peop'][t] = tsd['w_int'][t] * H_WE # (J/s = W)
