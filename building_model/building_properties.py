...
class BuildingProperties(object):
    ...
    def __init__(self, locator, building_names=None):
        ...
        self.building_names = [building_names[0]]
        ...
        prop_hvac.columns = prop_hvac.columns.str.lower() 
        prop_hvac.rename(columns = {'name':'Name'}, inplace= True)
        ...
        prop_architectures.columns = prop_architectures.columns.str.lower() 
        prop_architectures.rename(columns = {'name':'Name', 'hs_ag':'Hs_ag', 'hs_bg':'Hs_bg', 'ns':'Ns', 'es':'Es'}, inplace= True)
        ...
        prop_supply_systems_building.columns = prop_supply_systems_building.columns.str.lower() 
        prop_supply_systems_building.rename(columns = {'name':'Name'}, inplace= True)
        ...
        print(prop_architectures.columns)
        ...
        solar = get_prop_solar(locator, self.building_names, prop_rc_model, prop_envelope).set_index('Name')
...
def get_properties_technical_systems(locator, prop_HVAC):
    ...
    fields_emission_heating = ['Name', 'type_hs', 'type_cs', 'type_dhw', 'type_ctrl', 'type_vent', 'heat_start',
                               'heat_ends', 'cool_start', 'cool_ends', 'class_hs', 'convection_hs',
